...
# Read design
#-------------------------------------------------------------------------------
read_hdl -vhdl [format %s%s%s "../" ${LIBRARY} "/controlaswitch/entity/vhdl.vhd"]
read_hdl -vhdl [format %s%s%s "../" ${LIBRARY} "/spi/entity/vhdl.vhd"]
read_hdl -vhdl [format %s%s%s "../" ${LIBRARY} "/registerbank/entity/vhdl.vhd"]
read_hdl -vhdl [format %s%s%s "../" ${LIBRARY} "/pwm/entity/vhdl.vhd"]
read_hdl -vhdl [format %s%s%s%s%s "../" ${LIBRARY} "/" ${DESIGN} "/entity/vhdl.vhd"]
...
define_dft shift_enable -name scan_enable             -active high scanenable_in
define_dft test_mode    -name test_mode   -scan_shift -active high scantestmode_in
define_dft scan_chain   -name scan_f      -sdi scan_in -sdo scan_out 
